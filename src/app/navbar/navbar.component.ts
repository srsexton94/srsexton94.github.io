  ...
  template: `
    <nav
      ...
      [ngClass]="{
        ...
        'past-breakpoint': isPastBreakpoint
      }"
    >
      <div class="nav-header">
        ...
        <button
          class="menu-btn"
          [attr.aria-label]="menuToggle.label"
          (click)="handleMenuClick(true)"
        >
          <fa-icon
            class="icon menu"
            aria-hidden="true"
            [icon]="menuToggle.icon"
          ></fa-icon>
        </button>
      </div>
...
export class NavbarComponent {
  ...
  menuTabs: string[] = ['About me', 'Experience', 'Engineering', 'Community'];
